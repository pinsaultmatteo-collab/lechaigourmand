...
<link rel="canonical" href="https://chai-gourmand.fr/nos-references">
...
<meta property="og:url" content="https://chai-gourmand.fr/nos-references">
<meta property="og:image" content="https://chai-gourmand.fr/images/og-le-chai-gourmand.jpg">
...
{{
  ...
  "@graph": [
    {{
      "@type": "BreadcrumbList",
      "itemListElement": [
        {{"@type": "ListItem", "position": 1, "name": "Accueil", "item": "https://chai-gourmand.fr/"}},
        {{"@type": "ListItem", "position": 2, "name": "La cave", "item": "https://chai-gourmand.fr/cave-a-vin"}},
        {{"@type": "ListItem", "position": 3, "name": "Nos références", "item": "https://chai-gourmand.fr/nos-references"}}
      ]
    }},
    {{
      "@type": "CollectionPage",
      ...
      "url": "https://chai-gourmand.fr/nos-references",
      "isPartOf": {{"@id": "https://chai-gourmand.fr/#website"}},
      "about": {{"@id": "https://chai-gourmand.fr/#chai-francazal"}},
      "mainEntity": {{
        "@type": "ItemList",
